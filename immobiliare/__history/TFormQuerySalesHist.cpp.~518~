...
* @brief	Constructor
******************************************************************************/
__fastcall TFormQuerySalesHist::TFormQuerySalesHist(TComponent* Owner, TDataBanker* pDB)
	: TForm(Owner)
{
	assert(pDB);
...
{
	this->Caption = AnsiString(APPNAME) + " - Istogramma del numero di compravendite annuali";
...
void __fastcall TFormQuerySalesHist::SettingUpTheChart()
{
	...
	Chart->Title[0].Text->Text = "Istogramma del numero di compravendite annuali";
...
* @brief
******************************************************************************/
void __fastcall TFormQuerySalesHist::FormCanResize(TObject *Sender, int &NewWidth,
...
bool __fastcall TFormQuerySalesHist::ValidateInput()
{
    ...
    {
		::MessageBox(0,
        	"Error: End Date less than Start Date",
            "Error:",
