...
void __fastcall TFormQuerySales::Setup()
{
	this->Caption = AnsiString(APPNAME)
    	+ " - Analisi del valore medio delle compravendite (Euro/mq)";
...
void __fastcall TFormQuerySales::SettingUpTheChart()
{
	...
	Chart->Title[0].Text->Text = "Analisi del valore medio delle compravendite (Euro/mq)";
...
FormDebug->Print(strTemp);
        ...
        {
			::MessageBox(0, "No records found!", "Info:",
